        ...
        <div class="row">
            <div class="col-sm-offset-3 col-sm-6">
                <div class="row bann-widgets">
                    ...
                    <div class="col-xs-4"><a href="{{url('baking-gm')}}" class="active">Baking<br>with<br>Grand Mills</a></div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-sm-4 roboto">
            <div class="bg_gry_lt clearfix pad-20">
                ...
                <ul class="recipes_items">
                    <li><a href="{{url('recipes-regular')}}"><i class="fa fa-caret-right"></i> Recipes Regular</a></li>
                    <li><a href="{{url('recipes-light')}}"><i class="fa fa-caret-right"></i> Recipes Light</a></li>
                    <li class="active"><a href="{{url('baking-gm')}}"><i class="fa fa-caret-right"></i> Baking with Grand Mills</a></li>
                </ul>
